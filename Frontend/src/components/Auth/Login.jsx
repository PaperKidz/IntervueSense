  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center px-4">
      <div className="bg-white rounded-xl shadow-xl p-8 w-full max-w-md">
        <h1 className="text-3xl font-bold text-indigo-600 text-center mb-6">Welcome Back</h1>
        <p className="text-gray-500 text-center mb-8">Login to continue to VirtueSense</p>
